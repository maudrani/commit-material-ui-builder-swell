...
import tooltipsStyle from "../others/tooltipsStyle";
import imagesStyles from "../others/imagesStyles";
import customSelectStyle from "../others/customSelectStyle";

import { StyleRules } from "@mui/styles";

const productStyle: StyleRules = {
  mlAuto,
  main,
  ...imagesStyles,
  ...customSelectStyle,
